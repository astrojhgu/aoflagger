...
class ImagePropertiesWindow : public Gtk::Window {
	...
	private:
		...
		Gtk::RadioButton _grayScaleButton, _invGrayScaleButton, _hotColdScaleButton, _redBlueScaleButton, _blackRedScaleButton, _redBlueYellowScaleButton, _fireScaleButton, _coolScaleButton, _cubeHelixScaleButton, _cubeHelixColourfulScaleButton, _viridisScaleButton;
