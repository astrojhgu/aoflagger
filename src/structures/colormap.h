...
class MonochromeMap : public ColorMap {
	public:
		MonochromeMap() { }
		~MonochromeMap() { }
		unsigned char ValueToColorR(long double value) const override { return (unsigned char) (value*127.5+127.5); }
		unsigned char ValueToColorG(long double value) const override { return (unsigned char) (value*127.5+127.5); }
		unsigned char ValueToColorB(long double value) const override { return (unsigned char) (value*127.5+127.5); }
		unsigned char ValueToColorA(long double) const override { return 255; }
};
...
class InvertedMap : public ColorMap {
	public:
		InvertedMap() { }
		~InvertedMap() { }
		unsigned char ValueToColorR(long double value) const override { return (unsigned char) (127.5-value*127.5); }
		unsigned char ValueToColorG(long double value) const override { return (unsigned char) (127.5-value*127.5); }
		unsigned char ValueToColorB(long double value) const override { return (unsigned char) (127.5-value*127.5); }
		unsigned char ValueToColorA(long double) const override { return 255; }
};
...
class RedBlueMap : public ColorMap {
	public:
		RedBlueMap() { }
		~RedBlueMap() { }
		unsigned char ValueToColorR(long double value) const override {
			if(value>0.0)
				return (unsigned char) (value*255.0);
			else
				return 0;
		}
		unsigned char ValueToColorG(long double) const override { return 0; }
		unsigned char ValueToColorB(long double value) const override {
			if(value<0.0)
				return (unsigned char) (value*-255.0);
			else
				return 0;
...
class BlackRedMap : public ColorMap {
	public:
		...
		unsigned char ValueToColorG(long double value) const override
		{
			if(value>0.0)
				return (unsigned char) (255-value*255.0);
			else
...
class ContrastMap : public ColorMap {
	...
	public:
		...
		unsigned char ValueToColorA(long double value) const override { return _map->ValueToColorA(value>=0.0 ? sqrt(value) : -sqrt(-value)); }
};
...
class PosLogMap : public ColorMap {
	...
	public:
		explicit PosLogMap(const ColorMap &map) :
			_map(map) { }
		~PosLogMap() { }
		unsigned char ValueToColorR(long double value) const override { return value >= 0.0  ? _map.ValueToColorR((log10(value*0.9999+0.0001)+2.0)/2.0) : _map.ValueToColorR(-1.0); }
		unsigned char ValueToColorG(long double value) const override { return value >= 0.0  ? _map.ValueToColorG((log10(value*0.9999+0.0001)+2.0)/2.0) : _map.ValueToColorG(-1.0);  }
		unsigned char ValueToColorB(long double value) const override { return value >= 0.0  ? _map.ValueToColorB((log10(value*0.9999+0.0001)+2.0)/2.0) : _map.ValueToColorB(-1.0);  }
		unsigned char ValueToColorA(long double value) const override { return value >= 0.0  ? _map.ValueToColorA((log10(value*0.9999+0.0001)+2.0)/2.0) : _map.ValueToColorA(-1.0);  }
};
...
class FullLogMap : public ColorMap {
	...
	public:
		explicit FullLogMap(const ColorMap &map) :
			_map(map) { }
		~FullLogMap() { }
		unsigned char ValueToColorR(long double value) const override { return _map.ValueToColorR((log10(value*0.49995+0.50005)+2.0)/2.0); }
		unsigned char ValueToColorG(long double value) const override { return _map.ValueToColorG((log10(value*0.49995+0.50005)+2.0)/2.0);  }
		unsigned char ValueToColorB(long double value) const override { return _map.ValueToColorB((log10(value*0.49995+0.50005)+2.0)/2.0);  }
		unsigned char ValueToColorA(long double value) const override { return _map.ValueToColorA((log10(value*0.49995+0.50005)+2.0)/2.0);  }
};
...
class PositiveMap : public ColorMap {
	public:
		PositiveMap() { }
		~PositiveMap() { }
		unsigned char ValueToColorR(long double value) const override { return (unsigned char) (value>0.0 ? value*255.0 : 0); }
		unsigned char ValueToColorG(long double value) const override { return (unsigned char) (value>0.0 ? value*255.0 : 0); }
		unsigned char ValueToColorB(long double value) const override { return (unsigned char) (value>0.0 ? value*255.0 : 0); }
		unsigned char ValueToColorA(long double) const override { return 255; }
};
...
class InvPositiveMap : public ColorMap {
	public:
		InvPositiveMap() { }
		~InvPositiveMap() { }
		unsigned char ValueToColorR(long double value) const override { return (unsigned char) (value>0.0 ? 255.0-value*255.0 : 255.0); }
		unsigned char ValueToColorG(long double value) const override { return (unsigned char) (value>0.0 ? 255.0-value*255.0 : 255.0); }
		unsigned char ValueToColorB(long double value) const override { return (unsigned char) (value>0.0 ? 255.0-value*255.0 : 255.0); }
		unsigned char ValueToColorA(long double) const override { return 255; }
};
...
class LogInvPositiveMap : public ColorMap {
	public:
		LogInvPositiveMap() { }
		~LogInvPositiveMap() { }
		unsigned char ValueToColorR(long double value) const override { return (unsigned char) (value>0.0 ? -log10(value*0.9+0.1)*255.0 : 255.0); }
		unsigned char ValueToColorG(long double value) const override { return (unsigned char) (value>0.0 ? -log10(value*0.9+0.1)*255.0 : 255.0); }
		unsigned char ValueToColorB(long double value) const override { return (unsigned char) (value>0.0 ? -log10(value*0.9+0.1)*255.0 : 255.0); }
		unsigned char ValueToColorA(long double) const override { return 255; }
};
