...
namespace rfiStrategy {
	...
	bool ForEachBaselineAction::IsBaselineSelected(ImageSetIndex &index)
	{
		...
		if(dynamic_cast<FitsImageSet*>(&imageSet)!=nullptr
			|| dynamic_cast<BHFitsImageSet*>(&imageSet)!=nullptr
			|| dynamic_cast<FilterBankSet*>(&imageSet)!=nullptr
			|| dynamic_cast<QualityStatImageSet*>(&imageSet)!=nullptr
			|| dynamic_cast<RFIBaselineSet*>(&imageSet)!=nullptr)
			return true;
